			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"loginastra-display": {
								"semanticObject": "loginastra",
								"action": "display",
								"description": "loginastra",
								"title": "App Title",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=loginastra",
									"url": sap.ui.require.toUrl("loginastra")
								}
							}
						}
					}
